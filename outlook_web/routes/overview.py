...
def create_blueprint() -> Blueprint:
    ...
    bp.add_url_rule("/api/overview/verification-stats", view_func=overview_controller.api_get_overview_verification, methods=["GET"])
    bp.add_url_rule("/api/overview/external-api", view_func=overview_controller.api_get_overview_external_api, methods=["GET"])
    bp.add_url_rule("/api/overview/external-api-stats", view_func=overview_controller.api_get_overview_external_api, methods=["GET"])
